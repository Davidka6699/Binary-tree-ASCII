...
struct tree
{
    ...
    /**
     * @brief Функция getWidth находит ширину поддерева на указанном уровне
     * @param node указатель на узел (корень)
    ...
    /**
     * @brief Функция getMaxWidth находит максимальную ширину поддерева
     * @param node указатель на узел (корень)
    ...
    /**
     * @brief Функция printLevel возвращает строку, содержащую значение узлов на указанном уровне
     * @param node указатель на узел (корень)
     * @param level уровень ширина дерева
